...
/* =========================================================
   EMERALDOS 5.5 DEVELOPER EDITION PATCH
...
(function () {
        ...
        window.openWindow("Build Inspector", `
            <div style="padding:10px;">
                ...
                <div class="inset-panel">
                    <b>Build:</b> ${safeHTML(build.displayName || "EmeraldOS 5.5")}<br>
                    <b>Version:</b> ${safeHTML(build.version || "5.5")}<br>
    ...
    /* -----------------------------------------------------
       EMERALDOS 5.5 ADVANCED DEVELOPER PATCH
       - More apps
       - Expanded terminal
       - HKEY-style registry
    ...
    const DEFAULT_EMERALDOS_REGISTRY = {
        ...
        "HKEY_EMERALDOS\\SOFTWARE\\EmeraldOS\\CurrentVersion": "5.5",
        "HKEY_EMERALDOS\\SOFTWARE\\EmeraldOS\\BuildChannel": "Test",
        "HKEY_EMERALDOS\\SOFTWARE\\EmeraldOS\\BaseSystem": "EmeraldOS 5.5",
    ...
    window.runCommand = async function(cmdLine = "") {
        ...
        try {
            ...
            if (command === "help") {
                ...
                result = "EmeraldOS 5.5 Desktop Folders Suite Build";
            }

            else if (command === "about") {
                result = htmlLines([
                    "EmeraldOS 5.5",
                    "Current release: EmeraldOS 5.5",
    ...
    window.openAudioNotes = function () {
        window.openWindow("Audio Notes", `<div class="app-panel"><h3>Audio Notes</h3><p>Audio note recorder placeholder for EmeraldOS 5.5.</p><button onclick="notify('Audio Notes','Recorder initialized.',2500,'info')">Initialize Recorder</button></div>`, "audioNotes");
    };
    ...
    window.openScriptLab = function () {
        window.openWindow("Script Lab", `<div class="app-panel script-lab"><h3>Script Lab</h3><textarea id="script_lab_code" spellcheck="false">return 'Hello from EmeraldOS 5.5';</textarea><button onclick="runScriptLab()">Run</button><pre id="script_lab_output"></pre></div>`, "scriptLab");
    };
...
(function () {
    ...
    function installT4Apps() {
        ...
        window.openHelpCenter = () => simpleWindow("Help Center", `<h3>Help Center</h3><div class="inset-panel">Welcome to EmeraldOS 5.5. Applications are now organized into desktop folders. Double-click a folder to open its apps.</div>`, "helpCenter");
        ...
        window.openLicenseManager = () => simpleWindow("License Manager", `<h3>License Manager</h3><div class="inset-panel"><b>Active edition:</b> ${safeT4(localStorage.getItem('40_edition_name') || 'EmeraldOS Virtue')}<br><b>Build:</b> EmeraldOS 5.5</div>`, "licenseManager");
    ...
    function installRegistryT4() {
        try {
            if (window.EmeraldOSRegistry?.set) {
                ...
                window.EmeraldOSRegistry.set("HKEY_LOCAL_MACHINE\\System\\Build\\Version", "5.5");
    ...
    function installTerminalCommandsT4() {
        ...
        const wrapped = async function(cmdLine = "") {
            ...
            if (command === "help") {
                ...
                result = "EmeraldOS 5.5 adds true desktop app folders, consolidated app suites, HTML/Markdown/CSV viewers, registry defaults, and Firebase desktop layout sync.";
                ...
                result = "Package: " + safeT4(parts[0] || "unknown") + "<br>Status: installed<br>Build: 5.5";
            }
            if (result !== null) {
...
(function () {
    ...
    const BUILD_LABEL_T5 = "EmeraldOS 5.5";
...
/* =========================================================
   EMERALDOS 5.5 APPLICATION UPDATE
...
(function () {
    ...
    window.openReleaseNotes41 = function () {
        simple41("Release Notes", `
            <h3>EmeraldOS 5.5 Context Menu & Pinning Fix</h3>
            <ul>
    ...
    function installApps41() {
        register41("releaseNotes41", { name: "Release Notes", icon: "5.5", edition: "economy", category: "essential", launch: () => window.openReleaseNotes41() });
    ...
    function wrapTerminal41() {
        ...
        const wrapped = async function (cmdLine) {
            ...
            if (command === "storage.stats") {
                ...
                result = "EmeraldOS 5.5 Context Menu & Pinning Fix";
...
(function () {
    ...
    const BUILD_LABEL_42 = "EmeraldOS 5.5";
    ...
    async function scheduleCloudSettings42() {
        ...
        window.__emerald42CloudSettingsTimer = setTimeout(async () => {
            try {
                ...
                console.warn("EmeraldOS 5.5 cloud settings sync skipped:", err);
            }
        }, 600);
    }
    ...
    function installTerminalCommands42() {
        ...
        const wrapped = async function (cmdLine = "") {
            ...
            else if (cmd === "version" || cmd === "build") { result = "EmeraldOS 5.5 Context Menu & Pinning Fix"; }
            if (result !== null) {
                const output = document.getElementById("terminal_output");
                if (output) {
    ...
    function init42() {
        ...
        try { window.EmeraldOSRegistry?.set?.("HKEY_LOCAL_MACHINE\\System\\Build\\Version", "5.5"); } catch {}
        ...
        window.notify?.("EmeraldOS 5.5", "Pinning, Win95 menu, and control apps loaded.", 3500, "success");
    }
...
(function () {
    ...
    async function scheduleCloudSettings425() {
        ...
        window.__emerald426CloudSettingsTimer = setTimeout(async () => {
            try {
                ...
                console.warn("EmeraldOS 5.5 layout sync skipped:", err);
            }
        }, 650);
    }
    ...
    function patchTerminal425() {
        ...
        const wrapped = async function (cmdLine = "") {
            ...
            const cmd = (parts.shift() || "").toLowerCase();
            let result = null;
            if (cmd === "version" || cmd === "build") result = "EmeraldOS 5.5 Context Menu & Pinning Fix";
    ...
    function patchBuildLabels425() {
        try { document.title = document.title.replace("5.5", "5.5"); } catch {}
        try { window.EmeraldOSRegistry?.set?.("HKEY_LOCAL_MACHINE\\System\\Build\\Version", "5.5"); } catch {}
    ...
    function init425() {
        ...
        renderTaskbarPins425();
        renderStartPins425();
        window.notify?.("EmeraldOS 5.5", "Context menu, desktop pins, and Win95 notifications fixed.", 3500, "success");
    }
...
/* =========================================================
   EMERALDOS 5.5 RIGHT-CLICK HOTFIX
...
/* =========================================================
   EMERALDOS 5.5 AUDIO NOTES HOTFIX
